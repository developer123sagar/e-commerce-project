        ...
        <div className=" pt-3">
          <div className="max-w-9xl mx-auto">
            <div className="box-content w-full grid grid-auto-fit-lg bg-primary-700 mix-blend-multiply">
              ...
              <span className=" grid flex-wrap pt-5">
                <p className="text-white text-5xl pl-5">
                  Furnishing Is What We Do
                </p>
                <form className="flex flex-wrap gap-2 px-5 py-3">
                  <input
                    id="email"
                    className="text-black h-12 rounded-lg w-60"
                    type="email"
                  ...
                  <button
                    type="button"
                    className="bg-secondary-400 hover:bg-yellow-400 w-24 h-12 rounded-lg "
                  >
                    Get Started
                  </button>
                </form>
          ...
          <div className="border-t-[1px] border-yellow-600 w-[90%] mx-auto py-5">
            <span className="grid grid-auto-fit pt-4 text-lg">
              ...
              <div className="flex grid-auto-fit-md space-x-6">
                <ul>
                  <Link href="#" className="pr-5 hover:underline">
                    Policy
                  </Link>
                </ul>
                <ul>
