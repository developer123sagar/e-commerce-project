        ...
        <div className=" pt-3 h-screen ">
          <div className="max-w-9xl mx-auto">
            <div className="box-content w-full grid grid-auto-fit-lg bg-primary-700 mix-blend-multiply" >
              ...
              <div className=" pt-5">
                <p className="text-white text-4xl md:ml-0 mb-5">
                  Furnishing Is What We Do
                </p>
                <input
                className="bg-slate-50 focus:outline-none px-4 py-3 rounded w-1/2"
                  type="email"
                  placeholder="Enter your email"
                />
                <button
                  type="button"
                  className="bg-green-600 hover:bg-emerald-400 transition-all text-white px-10 py-3 rounded ml-4"
                >
                  SUBMIT
                </button>
              </div>
